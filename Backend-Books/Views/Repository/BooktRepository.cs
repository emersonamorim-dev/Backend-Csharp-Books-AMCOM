...
namespace Backend_Books.Views.Repository
{
    public class BookRepository
    {
        ...
        public Book GetBookById(string id)
        {
            ...
            return _books.Find<Book>(book => book.Id == objectId).FirstOrDefault();
        }
        ...
        {
            var objectId = new ObjectId(id);
            _books.ReplaceOne(b => b.Id == objectId, book);
        }

        public void Delete(string id)
        {
            var objectId = new ObjectId(id);
            _books.DeleteOne(book => book.Id == objectId);
        }

        public bool Exists(string id)
        {
            var objectId = new ObjectId(id);
            return _books.Find<Book>(book => book.Id == objectId).Any();
        }
    }
}
